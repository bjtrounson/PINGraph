(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.PINChart = factory(global.Chart, global.moment));
})(this, (function (chart_js, moment) { 'use strict';
    ...
    var PINChart = /** @class */ (function () {
        function PINChart(chartContainer, data) {
            ...
            this.chart = new chart_js.Chart(this.ctx, config);
        }
        ...
        PINChart.prototype.createTitleBar = function (data) {
            ...
            lastUpdated.innerHTML = "".concat(moment__default["default"](data.lastUpdated).utc(true).format("LLLL z"));
        ...
        PINChart.createLabels = function (data, period) {
            ...
            switch (period) {
                case Timeline.Day:
                    var hourDate = moment__default["default"](new Date(data.lastUpdated)).format("Do h:mm:ss a");
                    dateLabels = [hourDate];
                    for (var index = 0; index < arrLen; index++) {
                        dateLabels.push(moment__default["default"]().subtract(index, 'hours').format("Do h:mm:ss a"));
                    }
                    break;
                case Timeline.Week:
                    var todayDate = moment__default["default"](new Date(data.lastUpdated)).format("MMM D");
                    dateLabels = [todayDate];
                    for (var index = 0; index < arrLen; index++) {
                        dateLabels.push(moment__default["default"]().subtract(index, 'hours').format("MMM D"));
                    }
                    break;
            }
